#pragma checksum "D:\Users\bykov\source\repos\ArtRoyalDetailing — копия\ArtRoyalDetailing\Views\Sheduler\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "88fe0347c4dff583b203a5ca399c3708f2ac023e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"88fe0347c4dff583b203a5ca399c3708f2ac023e", @"/Views/Sheduler/Index.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "88fe0347c4dff583b203a5ca399c3708f2ac023e7934", async() => {
            }
            );
...
<script>
        ...
        getSelectedDate = (current_day, current_month, current_year) => {
           ...
           ");
            WriteLiteral(@"         let sheduler = document.querySelector('.sheduler')
                    ...
                    spanNoW.innerHTML = ""Мойщиков на смене пока не");
            WriteLiteral(@"т :(""
            ...
            WriteLiteral(@"erNavigation.userSurname} ${e.idWorkerNavigation.userName} c <i>${e.timeStart.value.hours}:${e.timeStart.value.minutes.toString().length == 1 ? ""0"" + e.timeStart.value.minutes.toString() : e.timeStart.value.minutes.toString()}</i> до <i>${e.timeStop.value.hours}:${e.timeStop.value.minutes.toString().length == 1 ? ""0"" + e.timeStop.value.minutes.toString() : e.timeStop.value.minutes.toString()}</i >`
                            ...
                            else if (e.idWorkerNavigation.userRole == 2)
                            {
                                ...
                                let span = document.createE");
            WriteLiteral(@"lement('span')
        ...
        addToSheduler = () => {
            if (inputValid()!= false) {
                var model = {
                    workerId:");
#nullable restore
#line 193 "D:\Users\bykov\source\repos\ArtRoyalDetailing — копия\ArtRoyalDetailing\Views\Sheduler\Index.cshtml"
