#pragma checksum "D:\Users\bykov\source\repos\ArtRoyalDetailing — копия\ArtRoyalDetailing\Views\Sheduler\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e0a1879c0022ce05656370ea785d6d9f89d3d5b9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e0a1879c0022ce05656370ea785d6d9f89d3d5b9", @"/Views/Sheduler/Index.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e0a1879c0022ce05656370ea785d6d9f89d3d5b97918", async() => {
            }
            );
        ...
        getSelectedDate = (current_day, current_month, current_year) => {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    sheduler.querySelector('.sheduler-he");
            WriteLiteral(@"ader').innerHTML = `<span><ion-icon name=""people-outline"" style=""height: 19px;""></ion-icon>Расписание на ${current_day.toString().length == 1 ? ""0"" + current_day.toString() : current_day.toString()}.${current_month.toString().length == 1 ? ""0"" + current_month.toString() : current_month.toString()}.${cy}</span>`
            ...
            WriteLiteral(@"admin-list').innerHTML = """"
                    ...
                    if(data!=null)
                    {
                        data.data.forEach((e) => {
                            if (e.idWorkerNavigation.userRole==3)
                            {
                                ...
                                span.innerHTML = `${e.idWorkerNavigation.userSurname} ${e.idWorkerNavigation.userName} c <i>${e.timeStart.value.hours}:${e.timeStart.value.minute");
            WriteLiteral(@"s.toString().length == 1 ? ""0"" + e.timeStart.value.minutes.toString() : e.timeStart.value.minutes.toString()}</i> до <i>${e.timeStop.value.hours}:${e.timeStop.value.minutes.toString().length == 1 ? ""0"" + e.timeStop.value.minutes.toString() : e.timeStop.value.minutes.toString()}</i >`
                            ...
                            else if (e.idWorkerNavigation.userRole == 2)
                            {
                                ...
                                let span = document.createElement('span')
                                span.innerHTML = `${e.idWorkerNavigation.userSurname} ${e.idWorkerNav");
            WriteLiteral(@"igation.userName} c <i>${e.timeStart.value.hours}:${e.timeStart.value.minutes.toString().length == 1 ? ""0"" + e.timeStart.value.minutes.toString() : e.timeStart.value.minutes.toString()}</i> до <i>${e.timeStop.value.hours}:${e.timeStop.value.minutes.toString().length == 1 ? ""0"" + e.timeStop.value.minutes.toString() : e.timeStop.value.minutes.toString()}</i>`
        ...
        addToSheduler = () => {
            if (inputValid()!= false) {
                var model = {
                    workerId:");
#nullable restore
#line 187 "D:\Users\bykov\source\repos\ArtRoyalDetailing — копия\ArtRoyalDetailing\Views\Sheduler\Index.cshtml"
