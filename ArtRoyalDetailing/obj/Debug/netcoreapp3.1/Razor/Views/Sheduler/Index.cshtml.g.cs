#pragma checksum "D:\Users\bykov\source\repos\ArtRoyalDetailing — копия\ArtRoyalDetailing\Views\Sheduler\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5e9ab2a279e8aa0df6a2ee1199bb8ac90cab3224"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5e9ab2a279e8aa0df6a2ee1199bb8ac90cab3224", @"/Views/Sheduler/Index.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5e9ab2a279e8aa0df6a2ee1199bb8ac90cab32247934", async() => {
            }
            );
...
<script>
        ...
        getSelectedDate = (current_day, current_month, current_year) => {
            ...
            WriteLiteral(@"er.querySelector('.sheduler-header').innerHTML = `<span><ion-icon name=""people-outline"" style=""height: 19px;""></ion-icon>Расписание на ${current_day.toString().length == 1 ? ""0"" + current_day.toString() : current_day.toString()}.${current_month.toString().length == 1 ? ""0"" + current_month.toString() : current_month.toString()}.${cy}</span>`
                    ...
                    shed");
            WriteLiteral(@"uler.querySelector('.sheduler-admin-list').innerHTML = """"
                    ...
                    if(data!=null)
                    {
                        data.data.forEach((e) => {
                            if (e.idWorkerNavigation.userRole==3)
                            {
                                ...
                                span.innerHTML = `${e.idWorkerNavigation.userSurname} ${e.idWorkerNavigation.userName} c <i>${e.timeStart.value.hou");
            WriteLiteral(@"rs}:${e.timeStart.value.minutes.toString().length == 1 ? ""0"" + e.timeStart.value.minutes.toString() : e.timeStart.value.minutes.toString()}</i> до <i>${e.timeStop.value.hours}:${e.timeStop.value.minutes.toString().length == 1 ? ""0"" + e.timeStop.value.minutes.toString() : e.timeStop.value.minutes.toString()}</i >`
...
#nullable restore
#line 192 "D:\Users\bykov\source\repos\ArtRoyalDetailing — копия\ArtRoyalDetailing\Views\Sheduler\Index.cshtml"
